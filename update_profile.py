...
# --- CONFIGURATION ---
GITHUB_USER = "thmspllgr" # <-- METS TON PSEUDO ICI
TOKEN = os.getenv("GITHUB_TOKEN")

def image_to_ascii_svg(image_path, new_width=65, start_x=30, start_y=40, line_height=10):
    ASCII_CHARS = ["@", "#", "8", "&", "o", ":", "*", ".", " "]
...
def main():
    ...
    print("5. Sauvegarde de github_stats.svg...")
